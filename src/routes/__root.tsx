  ...
  head: () => ({
    meta: [
      ...
      { title: "Darrow Code Astro Report" },
      {
        name: "description",
        content:
          "AI-powered personal astrology PDF built from your birth data — decoded through the Darrow Code Method.",
      },
      { name: "author", content: "Darrow Code" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+SC:wght@400;500&family=Cormorant+Garamond:wght@400;500;600&family=Inter:wght@400;500;600&display=swap",
      },

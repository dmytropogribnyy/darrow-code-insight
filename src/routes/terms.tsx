    ...
    <div className="min-h-screen flex flex-col bg-paper">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mt-6 space-y-4 text-[14px] text-charcoal leading-relaxed">
          <p>
            Darrow Code Astro Reports are sold as one-time digital products, delivered as PDF after
            successful payment.
          </p>
          <p>
          ...
          <p>
            Because reports are personalized digital goods generated immediately after payment, all
            sales are final unless the report fails to generate.
          </p>
        </div>
      </main>
      <SiteFooter />

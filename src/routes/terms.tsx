      ...
      >
        <div className="max-w-2xl mx-auto px-6 pt-16 sm:pt-20 pb-20 sm:pb-24">
          ...
          <div className="mt-7 space-y-4 text-[14px] sm:text-[15px] leading-[1.7] text-light-grey">
            <p>
              Darrow Code reports are personalized digital products generated from the birth data
              and report options submitted at checkout.
            </p>
            <p>
              By purchasing a report, you confirm that the birth data and email address you submit
              are accurate. Darrow Code is not responsible for incorrect report content caused by
            ...
            <h2 className="font-serif text-gold pt-5" style={{ fontSize: 20 }}>
              Report Delivery
            </h2>
            <p>
            ...
            <p>
              ...
              <span className="font-mono text-gold/90">DC-YYYYMMDD-0001</span>, which can be used
              for support and order tracking.
            </p>
            <p>
              If you contact us about an order, please include your order email, payment reference,
              or Darrow Code report reference.
            </p>
            ...
            <p>
              ...
              attempt to re-generate or re-deliver the purchased report at no additional charge. If
              we are unable to deliver the purchased report, we may issue a refund for the affected
              item.
            </p>

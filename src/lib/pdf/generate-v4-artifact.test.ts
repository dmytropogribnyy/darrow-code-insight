...
const FIXTURE_CORE_V4 = {
  ...
  core_architecture: {
    ...
    prose:
      "You are in a meeting. The numbers add up, the argument is clean, everyone is nodding — but you already feel it: a small wrongness, a gap between what is being said and what is actually going on. You cannot point to it yet. The feeling comes first; the explanation, if it comes at all, arrives much later.\n\nThis is not a sixth sense, and it is not anxiety. It is simply how you take the world in. Where others think their way to a conclusion, you feel your way there in the first few seconds, and the rest is catching up. By the time you have formed a sentence about a person, you have already decided whether you trust them.\n\nAstrology names this with three placements stacked in the same sign — Sun, Moon and rising all in Cancer. You do not need those words to recognize the result: you are the same person in private and in public, and you cannot perform a version of yourself you do not feel. When you try, it shows on your face before you have said a word.\n\nA second system, read in a completely different way, points at the same thing. Your Day Master in Chinese astrology is Gui Water — the deepest, most interior form of the Water element — and it sits at peak strength. Two traditions, one conclusion: a nature built for depth, for reading beneath the surface, for processing slowly and thoroughly rather than fast and shallow.\n\nThere is a cost, and it is worth saying plainly: you do not have thick skin. A tense or dishonest room does not just annoy you — it gets in the way of your thinking. You are sharpest in honest company and most scattered in false company. This is why the environment you choose is one of the most important decisions you make.",
    protocols: [
      {
  ...
  numerology_code: {
    ...
    prose:
      "Your Expression number is 8 — the builder, the one who holds structure and resources. This is your outward purpose: to organize, to carry weight, to hold together what would otherwise fall apart. When you have something substantial to hold, you are in your element; when you do not, that same capacity turns inward and wears on you.\n\nYour Soul Urge number is 7 — the seeker, who needs silence and meaning. This is what fuels you underneath. You need solitude the way others need company; time alone is not isolation but how you find your way back to clarity. Without it, everything slowly loses its edge.\n\nThese two pull in opposite directions, and that is the heart of it. The resolution is not to pick one but to run them together: you build something substantial in the world, powered by depth most people around you cannot see. The quiet study feeds the visible work.\n\nYour Personality number is 1 — what people read in the first few seconds: someone who decides, someone standing on their own. It earns respect and creates a little distance. Underneath all of it sits Life Path 3 — the integrator, who makes the complicated simple. That is the natural channel for everything above: you take depth and weight and translate it into something clear and usable for others.\n\nRight now you are at a turning point in the yearly cycle. The first half runs as a 4 — foundation, discipline, the slow groundwork that holds everything up. After mid-year it shifts to a 5 — movement, openness, room to expand. Trying to rush the first or resist the second is where the friction comes from.",
    protocols: [
      {
  ...
  shadow_and_friction: {
    ...
    prose:
      'You meet someone, or something — a person, a project, a possibility — and there is a flash: depth, potential, something rare. You lean in fully. Then reality slowly drifts from the picture you had already painted. You feel the gap before you can explain it, and what follows is not anger but a quiet pulling-back, a faint sense that you got it wrong.\n\nWhat is actually happening is that you fill people in early. Drawn to depth and to what is hidden in someone, you sometimes give them those qualities before they have shown them — offering more than the situation has earned. So the disappointment lands as if it were your misjudgment, when really you just believed in the picture too soon. The instinct toward depth is one of your best qualities; the risk is finishing the portrait before the person has finished painting it.\n\nThe second pattern you will know by how familiar it feels. Something gets uncertain — a shift in someone\'s tone, a signal you cannot read, a moment that asks you to trust — and instead of opening up to find out more, you go quiet. Outside you stay calm and polite; inside, a door closes. When something genuinely matters, your guard goes up first and your warmth follows later, if at all. It is not coldness — it is an old protective habit that cannot quite tell "this is unclear" from "this is dangerous," so it treats them the same.',
    protocols: [
      {
  ...
  executive_summary: {
    ...
    executive_summary_blocks: [
      ...
      },
      {
        ...
        content:
          "You are mid-shift in your yearly rhythm — from a foundation phase into a more open, expansive one around mid-year. The well-built parts of your life will hold and reward you now; the loosely held parts will ask to be reinforced. Build on solid ground first, then allow room to move — in that order.",
      },
      {
        label: "THE NEXT LEVEL" as const,
        content:
          "This document has mapped how you are built — your baseline, your operating conditions, the patterns you have sensed but never quite named. That foundation is complete on its own. If one pressure is loudest right now, a focused chapter goes deeper there — but there is nothing you need to buy to make this whole. You already have the base.",
      },
    ],
  },

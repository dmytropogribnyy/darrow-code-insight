...
function coreV3Instructions(): string {
  return [
    ...
    "Write like a calm, intelligent human speaking to another intelligent",
    "adult. Use astrology, BaZi and numerology as hidden architecture, not",
    "as the main language. The client should feel recognized before they",
    "feel explained.",
    "",
    "Do not lead with placements. Lead with lived experience. After the",
    "reader recognizes the pattern, use technical data only as proof",
    "support inside the trailing [proof tag].",
    "",
    "WRONG opening: \"Your Sun and Moon are both in Cancer, positioned in",
    "the 1st house…\"",
    "RIGHT opening: \"You are not built for surface-level noise. You",
    "notice what the room is trying not to say. The chart explains why —",
    "but the lived pattern comes first.\"",
    "",

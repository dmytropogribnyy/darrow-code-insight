  ...
  return {
    ...
    natal: {
      ...
      planets: [
        ...
        { name: "Mercury", sign: "Sagittarius", house: 3, retrograde: true },
        { name: "Venus", sign: "Aquarius", house: 5, dignity: "detriment" },
      ...
      aspects: [
        { a: "Venus", b: "Moon", type: "sextile", orb: 3.2, is_major: true, is_applying: true },
        { a: "Mars", b: "Saturn", type: "trine", orb: 1.4, is_major: true },
        { a: "Jupiter", b: "Saturn", type: "opposition", orb: 5.1, is_major: true },
        { a: "Saturn", b: "Sun", type: "square", orb: 2.0, is_major: true, is_applying: false },
      ],
    },
    numerology: {
      available: true,
    ...
    transits: {
      available: true,
      aspects: [
        { a: "Saturn", b: "Sun", type: "square", orb: 1.8, high_priority: true },
        { a: "Jupiter", b: "Venus", type: "trine", orb: 3.0, high_priority: true },
      ],
    },
    solar_return: {
      available: true,

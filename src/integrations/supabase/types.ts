...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      module_code: "CORE" | "LOVE" | "MONEY" | "BODY" | "YEAR" | "STYLE" | "PLACE" | "LOVE_TANDEM";
      order_status:
        | "pending"
        | "paid"
        | "processing"
        ...
        | "failed_generation"
        | "refunded";
      report_generation_status: "pending" | "processing" | "complete" | "failed_generation";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      generation_job_status: ["queued", "processing", "complete", "failed"],
      module_code: ["CORE", "LOVE", "MONEY", "BODY", "YEAR", "STYLE", "PLACE", "LOVE_TANDEM"],
      order_status: ["pending", "paid", "processing", "complete", "failed_generation", "refunded"],
      report_generation_status: ["pending", "processing", "complete", "failed_generation"],
    },
  },
} as const;

...
| 2026-06-02 | KB2-PLACE | 6 curated Darrow PLACE/AstroGeo rule docs created in docs/knowledge/rules/. All docs-only. No runtime activated. No maps, lines, city ranking, or relocation advice created. No source packs edited. No runtime changes. |
| 2026-06-02 | MOD-SUFF0 | 11 docs created in docs/knowledge/modules/ — data sufficiency matrix, per-module requirements (7 modules), fallback policy, and product copy guide. Docs-only. No runtime, prompt, schema, provider, checkout, or pricing changes. |
| 2026-06-02 | MOD-COPY-PATCH0 | Clarified CORE Complete delivery copy in MODULE_PRODUCT_COPY_GUIDE_v1.md. Removed "in one reading" / "one document" framing. Added "delivered separately" as canonical copy. Docs-only. No UI/checkout/pricing/runtime changes. |
